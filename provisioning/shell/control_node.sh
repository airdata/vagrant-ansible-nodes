...
function install_all() {
    ...
    yum install -y yum-utils yum-presto wget openssl epel-release curl mlocate device-mapper-persistent-data lvm2 vim net-tools python3 python3-pip python3-devel openssl-devel python3-libselinux gcc
